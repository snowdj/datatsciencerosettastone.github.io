...
%let path = G:\project\project1\sas\datatsciencerosettastone.github.io\;
...
proc import out = train
  ...
  datafile = '&path\data\tips_train.csv'
...
proc import out = test
  ...
  datafile = '&path\data\tips_test.csv'
